...
use atelier_app_api::{
    ...
    prompt::{
        AnalyzePromptRequestDto, CompileGenerationCharacterPromptDto,
        ...
        ListPromptPresetsRequestDto, PromptAnalysisDto, PromptChunkDto, PromptChunkPageDto,
        PromptDiagnosticDto, PromptDiagnosticSeverityDto, PromptFunctionTraceEntryDto,
        PromptHighlightSpanDto, PromptLexiconCatalogDto, PromptLexiconCategorySummaryDto,
        PromptLexiconEntryDto, PromptLexiconListQueryDto, PromptLexiconPageDto,
        PromptLexiconSearchQueryDto, PromptLexiconStatsDto, PromptLexiconSubcategorySummaryDto,
        PromptPresetDto, PromptPresetKindDto, PromptPresetPageDto, PromptSyntaxNodeDto,
        PromptSyntaxProfileDto, PromptTextRangeDto, PromptTokenDto, PromptTraceDto,
...
fn export_prompt_types(config: &Config) -> Result<(), String> {
    export_types!(
        config,
        PromptSyntaxProfileDto,
        AnalyzePromptRequestDto,
        PromptTextRangeDto,
        PromptTokenDto,
        PromptSyntaxNodeDto,
        PromptHighlightSpanDto,
        PromptDiagnosticSeverityDto,
        PromptDiagnosticDto,
        PromptAnalysisDto,
        PromptChunkDto,
