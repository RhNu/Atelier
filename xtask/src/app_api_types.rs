...
use atelier_app_api::{
    ...
    generation::{
        ...
        CharacterReferenceTypeDto, CountPromptTokensRequestDto, GenerateImageRequestDto,
        ...
        QualityPresetDto, QueueDelayDto, QueueDirectiveDto, RunGenerationJobRequestDto, SamplerDto,
