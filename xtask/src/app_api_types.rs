...
use atelier_app_api::{
    ...
    prompt::{
        ...
        PromptFunctionTraceEntryDto, PromptLexiconCatalogDto, PromptLexiconCategorySummaryDto,
    ...
    vibe::{
        ...
        ImportedVibeDocumentsDto, ListVibeDocumentsRequestDto, VibeDocumentEntryDto,
        VibeDocumentPageDto, VibeEncodingConfigDto, VibeExportFormatDto, VibeModelDto,
    },
