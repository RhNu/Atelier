...
def main() -> None:
    ...
    fetch_selected_command.add_argument("--names-from", type=Path, required=True)
    ...
    if args.command == "fetch-tags":
        ...
        enrich_file(args.input, args.output, args.cache)
    elif args.command == "semantic":
        build_semantic_assets(args.entities, args.output, args.batch_size)
    elif args.command == "normalize":
        normalize(args.input, args.output, args.allow, args.deny)
