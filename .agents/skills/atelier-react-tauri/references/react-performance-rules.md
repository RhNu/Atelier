# React Performance Rules for Atelier

This reference adapts Vercel React performance rules to Atelier's Tauri v2 + Vite + React 19 desktop webview. Use these rules when implementation details matter; keep `SKILL.md` as the short entry point.
