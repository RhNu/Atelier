...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::discover_agent_models,
            commands::save_agent_connection,
            commands::delete_agent_connection,
            commands::save_agent_model,
            commands::delete_agent_model,
            commands::get_agent_workspace_settings,
            commands::update_agent_workspace_settings,
            ...
            commands::get_resource_library_snapshot,
            commands::upsert_resource_library_folder,
            commands::update_resource_library_resource,
            commands::delete_resource_library_folder,
            ...
            commands::list_explore_sources,
            commands::search_explore_posts,
            commands::get_explore_post_detail,
            commands::get_explore_media,
